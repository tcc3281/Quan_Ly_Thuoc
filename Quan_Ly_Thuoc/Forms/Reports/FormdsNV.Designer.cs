namespace Quan_Ly_Thuoc.Forms.Reports
{
	partial class FormdsNV
	{
		...
		private void InitializeComponent()
		{
			...
			// rpvNV
			// 
			this.rpvNV.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rpvNV.LocalReport.ReportEmbeddedResource = "Quan_Ly_Thuoc.Reports.ReportHDN.rdlc";
			this.rpvNV.Location = new System.Drawing.Point(3, 18);
			this.rpvNV.Name = "rpvNV";
			this.rpvNV.ServerReport.BearerToken = null;
			this.rpvNV.Size = new System.Drawing.Size(794, 360);
			...
			this.label1.Text = "Tìm kiếm theo quý:";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.rpvNV);
