namespace Quan_Ly_Thuoc.Forms.Reports
{
	partial class FormdsHDB
	{
		...
		private void InitializeComponent()
		{
			...
			this.rpvHDB = new Microsoft.Reporting.WinForms.ReportViewer();
			...
			this.label1.Text = "Tìm kiếm theo năm:";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.rpvHDB);
			...
			// rpvHDB
			// 
			this.rpvHDB.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rpvHDB.LocalReport.ReportEmbeddedResource = "Quan_Ly_Thuoc.Reports.ReportHDN.rdlc";
			this.rpvHDB.Location = new System.Drawing.Point(3, 18);
			this.rpvHDB.Name = "rpvHDB";
			this.rpvHDB.ServerReport.BearerToken = null;
			this.rpvHDB.Size = new System.Drawing.Size(794, 360);
			this.rpvHDB.TabIndex = 0;
			// 
			// groupBox1
			// 
		...
		private Microsoft.Reporting.WinForms.ReportViewer rpvHDB;
